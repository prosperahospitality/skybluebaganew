    ...
    const handleCheckout = async () => {
        ...
        try {
            ...
            let payload = {
                ...
                phone: "",
                Hotel_Id: "123456",
                Hotel_name: "Hotel Sky Blue Baga",
    ...
    const fetchfilteritemdata = [
        {
            ...
            intro: `Experience ultimate comfort and relaxation in our Double-Bed AC Rooms at Hotel Sky Blue Baga. Designed for a peaceful stay, these rooms feature spacious interiors, modern amenities, and a cool, refreshing ambiance to help you unwind after a day of exploring the beautiful surroundings of Goa. Whether you're here for a short getaway or an extended stay, our AC rooms offer a perfect blend of comfort and convenience, ensuring you have an unforgettable experience.`,
            value: true,
            amount: "1000",
            adultCount: "2",
            childCount: "2",
