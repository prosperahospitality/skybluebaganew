...
const Reviews = ({ packageReviews }) => {
    const reviews = [
        {
            title: "A Comfortable Stay Near Goa Hills",
            description:
                "Experience the serenity of Goa with a comfortable stay at Hotel Sky Blue Baga. Clean rooms and friendly staff make it an ideal choice for travelers.",
            name: "Rohit Mehta",
            gender: "Male",
            img: IMAGES.profile,
        },
        {
            ...
            description:
                "Enjoy affordable accommodation close to Goa attractions. Convenient location and good hospitality add to the charm of this stay.",
            name: "Simran Patel",
            gender: "Female",
            img: IMAGES.profile,
        },
        {
            title: "Perfect Base for Exploring Goa",
            description:
                "Hotel Sky Blue Baga serves as the perfect base for exploring Goa. With basic amenities and a prime location, it's a good value for money.",
            name: "Vikram Desai",
            gender: "Male",
            img: IMAGES.profile,
        },
        {
            ...
            description:
                "The staff at Hotel Sky Blue Baga went above and beyond to make our stay memorable. Comfortable rooms and delicious local food were the highlights.",
            name: "Nisha Sharma",
            gender: "Female",
            img: IMAGES.profile,
        },
        {
            ...
            description:
                "Hotel Sky Blue Baga is an excellent choice for budget-conscious travelers. Its proximity to Goa attractions is a big plus.",
            name: "Arjun Varma",
            gender: "Male",
            img: IMAGES.profile,
        },
        {
            ...
            description:
                "The hotel offers a peaceful ambiance with clean rooms and courteous staff. A great option for a short getaway near Goa.",
            name: "Priya Menon",
            gender: "Female",
            img: IMAGES.profile,
        },
        {
            ...
            description:
                "Located near the main attractions, Hotel Sky Blue Baga provides excellent hospitality. The staff ensured a comfortable and pleasant stay.",
            name: "Kunal Joshi",
            gender: "Male",
            img: IMAGES.profile,
        },
        ...
        <div className="bg-gray-100">
            <div className="flex flex-col gap-8 lg:gap-10 justify-center items-center py-20 w-[95%] mx-auto">
                ...
                <p className="text-base lg:text-lg lg:w-[80%] text-center">
                    Hear the glowing stories and testimonials from guests who’ve experienced the unmatched hospitality and comfort of Hotel Sky Blue Baga!
                </p>
